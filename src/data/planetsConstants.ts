export const PLANETS_DATA = [
  ...
  },
  {
    ...
    satellites: [
      { id: 'moon', name: 'Moon', distance: 15, speed: 1.5, size: 4, color: 'bg-gray-300' },
      { id: 'iss', name: 'ISS', distance: 22, speed: -2.5, size: 2, color: 'bg-blue-400', isTech: true }
    ]
  },
  {
    ...
    satellites: [
      { id: 'phobos', name: 'Phobos', distance: 12, speed: 2, size: 3, color: 'bg-gray-400' },
      { id: 'deimos', name: 'Deimos', distance: 18, speed: 1.2, size: 2, color: 'bg-gray-500' }
    ]
  },
  {
    ...
    satellites: [
      { id: 'io', name: 'Io', distance: 25, speed: 1.8, size: 5, color: 'bg-yellow-200' },
      { id: 'europa', name: 'Europa', distance: 35, speed: 1.4, size: 4, color: 'bg-blue-100' },
      { id: 'ganymede', name: 'Ganymede', distance: 45, speed: 1, size: 6, color: 'bg-gray-400' }
    ]
  },
  {
    ...
    satellites: [
      { id: 'titan', name: 'Titan', distance: 28, speed: 0.8, size: 5, color: 'bg-orange-200' },
      { id: 'rhea', name: 'Rhea', distance: 20, speed: 1.2, size: 3, color: 'bg-gray-200' }
    ]
  },
  {
    ...
    satellites: [
      { id: 'titania', name: 'Titania', distance: 18, speed: 1.5, size: 3, color: 'bg-blue-50' },
      { id: 'miranda', name: 'Miranda', distance: 12, speed: 2.2, size: 2, color: 'bg-white' }
    ]
  },
  {
    ...
    satellites: [
      { id: 'triton', name: 'Triton', distance: 15, speed: -1.2, size: 4, color: 'bg-blue-200' }
    ]
  }
];
